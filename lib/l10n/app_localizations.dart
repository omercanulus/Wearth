...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'tr': {
      ...
      'quickMode': 'HIZLI MOD',
      'leaveMatch': 'Maçtan Ayrıl',
      'leaveMatchWarning': 'Ayrılırsan maçı kaybedersin. Emin misin?',
      'yes': 'Evet',
      'no': 'Hayır',
      'wantsToBeFriend': 'sana arkadaşlık isteği gönderdi!',
      'rematch': 'Tekrar Oyna',
      ...
      'noRequests': 'Gelen istek yok.',
      'noResults': 'Kullanıcı bulunamadı.',
      'friendAdded': 'İstek gönderildi!',
      'acceptRequest': 'Kabul Et',
      'declineRequest': 'Reddet',
      'cancelRequest': 'İptal Et',
      'blockUser': 'Engelle',
      'unblockUser': 'Engeli Kaldır',
      'friendshipRemoved': 'Arkadaşlıktan çıkarıldı.',
      'unfriendConfirm': 'Arkadaşlıktan çıkarmak istediğinize emin misiniz?',
      'blockConfirm': 'Bu kullanıcıyı engellemek istediğinize emin misiniz?',
    },
    'en': {
      // App
      'appTitle': 'WEARTH',
      ...
      'leaveMatchWarning': 'If you leave, you will lose the match. Are you sure?',
      'yes': 'Yes',
      'no': 'No',
      'wantsToBeFriend': 'sent you a friend request!',
      'rematch': 'Rematch',
      ...
      'blockUser': 'Block',
      'unblockUser': 'Unblock',
      'friendshipRemoved': 'Removed from friends.',
